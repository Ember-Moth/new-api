...
internal/module/identity/ — Account CRUD, OAuth provider/binding management, external identity ownership and authorization; authz exposes the instance API and internal/authorization owns Casbin storage and policy snapshots; login, security factors and session runtime are still being migrated
