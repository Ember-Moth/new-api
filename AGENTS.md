...
internal/module/subscription/ — Plan configuration/cache, grants/queries/resets/cancellation/expiry, quota reservation/refund/accounting and maintenance; payment flows and legacy runtime adapters are still being migrated
