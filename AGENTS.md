...
internal/module/usage/ — Log entities, audience filtering, cursors, queries, statistics and cleanup; billing/audit event assembly still has transitional callers
