...
internal/module/billing/ — Redemption management/use, top-up settlement/history/manual completion, transactional wallet operations, subscription receipts and checkout clients; relay quota/cache batching, pricing and webhook orchestration are still being migrated
...
internal/module/subscription/ — Plan configuration/cache, grants/lifecycle, quota accounting, payment orders, balance purchase and maintenance; Stripe/Creem/Waffo webhook dispatch and legacy configuration/runtime adapters are still being migrated
