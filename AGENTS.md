...
internal/module/identity/ — Account CRUD, OAuth bindings, external identity ownership, two-factor management and authorization; authz exposes the instance API and internal/authorization owns Casbin storage and policy snapshots; login, passkeys and session runtime are still being migrated
