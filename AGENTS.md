...
internal/module/usage/ — Log entities, audience filtering, event assembly, cursors, queries, hourly aggregation, dashboard/ranking statistics and cleanup; pricing metadata wiring and legacy event adapters remain transitional
