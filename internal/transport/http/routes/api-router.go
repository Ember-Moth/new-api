	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.GET("/topup/info", billingHandler.GetTopUpInfo)
				selfRoute.GET("/topup/self", billingHandler.GetUserTopUps)
				selfRoute.POST("/topup", middleware.CriticalRateLimit(), billingHandler.Redeem)
				selfRoute.POST("/pay", middleware.CriticalRateLimit(), billingHandler.RequestEpay)
				selfRoute.POST("/amount", billingHandler.RequestAmount)
				selfRoute.POST("/stripe/pay", middleware.CriticalRateLimit(), billingHandler.RequestStripePay)
				selfRoute.POST("/stripe/amount", billingHandler.RequestStripeAmount)
				selfRoute.POST("/creem/pay", middleware.CriticalRateLimit(), billingHandler.RequestCreemPay)
				selfRoute.POST("/waffo/amount", billingHandler.RequestWaffoAmount)
			...
			adminRoute.Use(middleware.AdminAuth())
			{
				...
				adminRoute.GET("/topup", billingHandler.GetAllTopUps)
				adminRoute.POST("/topup/complete", billingHandler.AdminCompleteTopUp)
		...
		optionRoute.Use(middleware.RootAuth())
		{
			...
			optionRoute.POST("/waffo-pancake/subscription-product", billingHandler.CreateWaffoPancakeSubscriptionProduct)
			optionRoute.GET("/waffo-pancake/subscription-product-options", billingHandler.ListWaffoPancakeSubscriptionProductOptions)
		}
