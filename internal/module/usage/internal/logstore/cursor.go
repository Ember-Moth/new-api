...
func (r *Store) NewLogCursorPage(encoded, scope string) (*LogCursorPage, error) {
...
func (r *Store) selectLogCursorPage(query *gorm.DB, limit int, page *LogCursorPage) ([]*Log, error) {
