...
func UserJSON(value string) string  { return formatLogOtherJSON(value, logOtherVisibilityUser) }
func AdminJSON(value string) string { return formatLogOtherJSON(value, logOtherVisibilityAdmin) }
func RootJSON(value string) string  { return formatLogOtherJSON(value, logOtherVisibilityRoot) }
