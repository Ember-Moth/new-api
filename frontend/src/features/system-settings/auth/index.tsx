...
const defaultAuthSettings: AuthSettings = {
  ...
  GitHubClientId: '',
  GitHubClientSecret: '',
  GitHubClientSecret_configured: false,
  'discord.enabled': false,
  'discord.client_id': '',
  'discord.client_secret': '',
  'discord.client_secret_configured': false,
  'oidc.enabled': false,
  'oidc.client_id': '',
  'oidc.client_secret': '',
  ...
  TelegramBotToken: '',
  TelegramBotToken_configured: false,
  TelegramBotName: '',
  LinuxDOOAuthEnabled: false,
  LinuxDOClientId: '',
  LinuxDOClientSecret: '',
  LinuxDOClientSecret_configured: false,
  LinuxDOMinimumTrustLevel: '0',
  WeChatAuthEnabled: false,
  WeChatServerAddress: '',
  WeChatServerToken: '',
  WeChatServerToken_configured: false,
  WeChatAccountQRCodeImageURL: '',
  TurnstileCheckEnabled: false,
  TurnstileSiteKey: '',
  TurnstileSecretKey: '',
  TurnstileSecretKey_configured: false,
