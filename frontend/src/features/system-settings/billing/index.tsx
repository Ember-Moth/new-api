...
const defaultBillingSettings: BillingSettings = {
  ...
  StripeApiSecret: '',
  StripeApiSecret_configured: false,
  StripeWebhookSecret: '',
  StripeWebhookSecret_configured: false,
  StripePriceId: '',
  StripeUnitPrice: 8.0,
  StripeMinTopUp: 1,
  ...
  StripePaymentIntentApiSecret_configured: false,
  StripePaymentIntentWebhookSecret: '',
  StripePaymentIntentWebhookSecret_configured: false,
  ...
  CreemWebhookSecret: '',
  CreemWebhookSecret_configured: false,
  CreemTestMode: false,
  CreemProducts: '[]',
  WaffoEnabled: false,
  WaffoApiKey: '',
  WaffoApiKey_configured: false,
  WaffoPrivateKey: '',
  WaffoPrivateKey_configured: false,
  WaffoPublicCert: '',
  WaffoSandboxPublicCert: '',
  WaffoSandboxApiKey: '',
  WaffoSandboxApiKey_configured: false,
  WaffoSandboxPrivateKey: '',
  WaffoSandboxPrivateKey_configured: false,
  WaffoSandbox: false,
  WaffoMerchantId: '',
  WaffoCurrency: 'USD',
  WaffoUnitPrice: 1,
  ...
  WaffoPancakePrivateKey_configured: false,
